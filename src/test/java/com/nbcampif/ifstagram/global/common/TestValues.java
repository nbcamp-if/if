...
public class TestValues {
  ...
  public final static UserUpdateRequestDto TEST_USER_UPDATE_REQUEST_DTO =
      new UserUpdateRequestDto(TEST_UPDATE_INTRODUCTION, TEST_UPDATE_NICKNAME, TEST_UPDATE_PROFILEIMAGE);
  public final static User TEST_UPDATED_USER = new User(TEST_ID1, TEST_EMAIL1, TEST_UPDATE_NICKNAME, TEST_UPDATE_PROFILEIMAGE, TEST_UPDATE_INTRODUCTION, 0L, UserRole.USER);
